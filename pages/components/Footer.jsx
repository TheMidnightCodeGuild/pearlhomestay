...
const Footer = () => {
  return (
    <>
      <Head>
        <title>
          Pearl Homestay Ujjain - Comfortable Stay Near Mahakal Temple
        </title>
        <meta
          name="description"
          content="Pearl Homestay offers comfortable accommodation near Mahakaleshwar Temple in Ujjain. Book your stay with us for a memorable spiritual experience."
        />
        <meta
          name="keywords"
          content="Pearl Homestay, Ujjain accommodation, Mahakal Temple stay, homestay near Mahakaleshwar Temple"
        />
        <meta
          property="og:title"
          content="Pearl Homestay Ujjain - Comfortable Stay Near Mahakal Temple"
        />
        <meta
