...
const Testimonial = () => {
  ...
  return (
    <>
      <section
        id="testimonials"
        className="py-8 xs:py-10 sm:py-12 md:py-16 bg-[#C6A38D] border-l-[10px] border-r-[10px] border-[#ffffff]"
      >
        <div
          ref={sectionRef}
        ...
        >
          <div className="text-center mb-6 xs:mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold mb-2 xs:mb-3 sm:mb-4 text-neutral-800 px-2">
              Guest Experiences: Why Our Homestay is the Perfect Spiritual Stay
            </h2>
            <p className="text-sm xs:text-base md:text-base text-neutral-900 max-w-4xl mx-auto px-2">
          ...
          <Swiper
            ...
            className="swiper-container px-2"
          >
            {TestimonialData.map((data) => (
              <SwiperSlide key={data.id}>
                <div className="bg-white rounded-lg shadow-xl overflow-hidden h-[250px] xs:h-[275px] sm:h-[300px] border-2 border-[#8B593E]">
                  <div className="p-3 xs:p-4 sm:p-5 md:p-6 flex flex-col justify-between h-full">
                    <div className="text-gray-600 italic mb-2 xs:mb-3 sm:mb-4 flex-grow overflow-y-auto text-xs xs:text-sm sm:text-base">
                      &quot;{data.content}&quot;
                    </div>
                    <div className="flex items-center mt-auto">
                      ...
                      <div className="ml-2 xs:ml-3 sm:ml-4">
                        <div className="text-sm xs:text-base sm:text-lg font-medium text-[#4A2511]">
                          {data.name}
                        </div>
                        <div className="text-xs xs:text-sm text-[#8B593E]">
                          {data.role}
                        </div>
                      </div>
                    </div>
