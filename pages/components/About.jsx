...
const About = () => {
  ...
  return (
    <>
      <Head>
        <title>About Pearl Homestay - Your Gateway to Mahakal Temple in Ujjain</title>
        <meta name="description" content="Experience divine comfort at Pearl Homestay, located near Mahakaleshwar Temple in Ujjain. Perfect accommodation for pilgrims visiting the sacred Jyotirlinga." />
        <meta name="keywords" content="Pearl Homestay, Ujjain accommodation, Mahakal Temple stay, pilgrim homestay Ujjain, Mahakaleshwar Temple accommodation" />
        <meta property="og:title" content="About Pearl Homestay - Your Gateway to Mahakal Temple in Ujjain" />
        <meta property="og:description" content="Experience divine comfort at Pearl Homestay, located near Mahakaleshwar Temple in Ujjain. Perfect accommodation for pilgrims visiting the sacred Jyotirlinga." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://pearlhomestayujjain.in/components/About" />
        <meta property="og:image" content="https://pearlhomestayujjain.in/images/about.png" />
      </Head>
          ...
          <div className="bg-[#fffff0]  rounded-4xl shadow-xl overflow-hidden  transition-all duration-300 hover:shadow-2xl">
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/2 p-6 md:p-10">
                ...
                <p className="text-[#8B593E] font-medium mb-6 uppercase tracking-wider text-sm md:text-base">About Us</p>
                <div className="md:block hidden">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed pb-4 border-b border-[#8B593E]/20">
                    ...
                    in the powerful Bhasma Aarti and other rituals at the Mahakal Temple. 
                  </p>
                </div>
                <div className="md:hidden block">
                  <p className="text-sm text-gray-700 leading-relaxed mb-4 pb-4 border-b border-[#8B593E]/20">
                    Experience the divine aura of Mahakaleshwar Temple with a comfortable stay at 
                    Pearl Homestay in Ujjain. Our thoughtfully designed accommodation offers pilgrims 
                    the perfect retreat.
                  </p>
                  <p className="text-sm text-gray-700 leading-relaxed pb-4 border-b border-[#8B593E]/20">
                    Located near the sacred Mahakal Temple, our homestay provides 
                    a serene environment where you can reflect on your spiritual journey while enjoying 
                    modern comforts.
                  </p>
                </div>
