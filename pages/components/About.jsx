...
const About = () => {
  return (
    <section className="w-full min-h-screen bg-[#C6A38D] py-24 px-4 border-l-[10px] border-r-[10px] border-b-[10px] border-[#8B593E]">
        ...
        <div className="bg-[#fffff0] rounded-2xl shadow-xl overflow-hidden mb-20 transition-all duration-300 hover:shadow-2xl">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 p-10">
              ...
              <p className="text-[#8B593E] font-medium mb-6 uppercase tracking-wider text-base">About Us</p>
