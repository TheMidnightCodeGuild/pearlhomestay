...
const HomePage = () => {
  ...
  return (
    <main className="bg-[#C6A38D] border-r-[10px] border-l-[10px] border-[#ffffff] ">
      <section className="flex flex-col md:flex-row justify-center items-center min-h-[calc(100vh-80px)] p-4 md:p-8 mx-0 sm:mx-12 sm:mt-[80px] mt-[40px] bg-[#C6A38D] ">
        <div className="w-full md:w-1/2 px-2 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
          <div className="md:mb-2 mt-2 sm:mt-4 md:mt-6 ">
            <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-[59px] font-extralight text-[#4A2511] uppercase font-masiku md:bg-transparent p-2 rounded-lg  ">
              <span className="text-center font-masiku mx-14">Welcome to</span>
              <br className="hidden md:block" />
              <span className="text-[#8B593E] animate-pulse font-masiku block mt-2 ml-6 sm:ml-0">
                Pearl Homestay
              </span>
            </h1>
          </div>

          <div className="block md:hidden " ref={mobileImageRef}>
            <Image
              src="/images/home.png"
          ...
          <p className="text-sm sm:text-base md:text-base text-[#4A2511]/90 mt-4 sm:mt-6 max-w-lg mx-auto md:mx-0 italic md:bg-transparent rounded-lg mb-4 font-bold text-center px-2 sm:px-4">
            &quot;Experience comfort and tranquility at our family-run homestay.
            Cozy rooms with personalized service.&quot;
          </p>

          <div className="flex justify-center md:justify-start mt-4 sm:mt-6 mx-0 sm:mx-48">
            <Link
              href="/booking"
              target="_blank"
        ...
        <div className="hidden md:flex w-full md:w-1/2 px-4 py-4 sm:py-6 md:py-10 justify-center items-center ">
          <div className="w-full max-w-lg relative" ref={desktopImageRef}>
            <Image
              src="/images/home.png"
              alt="Pearl Homestay Ujjain - Luxury Accommodation Near Mahakal Temple"
              width={600}
