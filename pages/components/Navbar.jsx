...
const Navbar = () => {
  ...
  return (
    <>
      <Head>
        <title>Pearl Homestay Ujjain - Navigation</title>
        <meta name="description" content="Navigate through Pearl Homestay Ujjain's website to explore our accommodations, services, gallery and contact information. Easy booking available." />
        ...
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 py-0">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-1 lg:space-x-2" role="menubar">
              ...
              <Link href="/booking" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-[#8B593E] rounded-full shadow-md group" role="menuitem">
